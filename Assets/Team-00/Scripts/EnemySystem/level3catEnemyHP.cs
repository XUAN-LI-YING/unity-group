...
public class level3catEnemyHP : MonoBehaviour
{

  public static level3catEnemyHP instance;
  // 函式 instance
  ...
  {                                                             //如果目前血量HP小於等於0，那就會讓這個物件，也就是敵人消失
    if (hp <= 0)
    {
    //   EnemyPrefab.instance.addEnemyDie();          //第一關
       DevilEnemyPra.instance.addEnemyDie();          //第二關
